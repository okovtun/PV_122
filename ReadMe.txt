...
TODO:
Используя существующий двусвязный список, в отдельном проекте реализовать приложение
"Телефонная книга".

DONE:
Вынести методы классов: Element, и всех итераторов за класс, 
и при успешном результате разделить на файлы.
