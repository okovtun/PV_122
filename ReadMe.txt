...
TODO:
В проекте Department реализовать 2 типа сотрудников, первый тип получает стебильную ставку,
второй тип почасовую оплату.
Необходимо создать массив сотрудников department, вывести на экран зарплату за месяц всех сотрудников отдела
и рассчитать общую сумму денег для всего отдела.
Сохранить список сотрудников и их зарплату в файл.
Загрузить department из файла и вывести его на экран.
Почитать про CSV-формат.
